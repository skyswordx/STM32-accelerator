...
/*********************************************************************************************************
** 函数名称 ：void delay_ms(uint32_t ms)
** 函数功能 ：基于delay_us的毫秒延时函数
** 入口参数 ：ms - 延时时间（毫秒）
** 出口参数 ：无
** 函数说明 ：使用delay_us实现毫秒延时，不依赖systick
*********************************************************************************************************/
...
** 入口参数 ：无
** 出口参数 ：无
** 函数说明 ：GPIO初始化已由CubeMX配置，此函数仅设置初始状态
**************************************************************/
void AD9954_GPIO_Init(void)
{
	// GPIO初始化已由CubeMX配置，此处仅设置初始状态
	AD9954_RES(0);
	AD9954_CS(0);
	AD9954_SCLK(0);
	AD9954_SDIO(0);
